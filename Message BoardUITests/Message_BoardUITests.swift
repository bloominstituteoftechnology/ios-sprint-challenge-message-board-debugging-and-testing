...
class Message_BoardUITests: XCTestCase {
    ...
    func testCreateNewMessage() {
        ...
        app.tables/*@START_MENU_TOKEN@*/.staticTexts["new"]/*[[".cells.staticTexts[\"new\"]",".staticTexts[\"new\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
        ...
        XCTAssertTrue(app.staticTexts["yay"].exists)
        XCTAssertTrue(app.staticTexts["New Message"].exists)
    }
