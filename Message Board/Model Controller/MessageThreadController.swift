...
class MessageThreadController {
    static let baseURL = URL(string: "https://message-board-sprint-8.firebaseio.com/")!
    ...
    func createMessageThread(with title: String, completion: @escaping () -> Void) {
        ...
        URLSession.shared.dataTask(with: request) { (data, _, error) in
            ...
            completion()
        // MARK:  BUG 01
        // Added .resume() This allows the new thread to be created and uploaded to firebase.
        }.resume()
    }
